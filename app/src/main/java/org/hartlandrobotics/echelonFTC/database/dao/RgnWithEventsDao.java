...
import org.hartlandrobotics.echelonFTC.database.entities.RgnWithEvts;
...
public abstract class RgnWithEventsDao {
   ...
   @Transaction
   @Query("SELECT * FROM Rgn WHERE regionCode = :regionCode")
   public abstract LiveData<RgnWithEvts> getRgnEvents(String regionCode );
}